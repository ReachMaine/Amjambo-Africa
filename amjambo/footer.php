	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info  changed zig -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( '&copy; %1$s', 'extra' ) ), date("Y").'<a target="_blank" href="http://www.laddertothemoonnetwork.org/" title="Ladder to the Moon Network"> Ladder to the Moon Network</a>' ); ?></p>
